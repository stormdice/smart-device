...
/* harmony import */ var _vendor_for_each_polyfill_ie11__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vendor/for-each-polyfill-ie11 */ "./src/js/vendor/for-each-polyfill-ie11.js");
...
/* harmony import */ var _modules_navigation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/navigation */ "./src/js/modules/navigation.js");
...
Object(_modules_navigation__WEBPACK_IMPORTED_MODULE_6__["openNav"])();
Object(_modules_footer__WEBPACK_IMPORTED_MODULE_7__["initMobileAccordeonInFooter"])();
var linkBackCall = document.querySelector('.js-open-modal-backcall');
...
/*!**********************************!*\
  !*** ./src/js/modules/footer.js ***!
  \**********************************/
/*! exports provided: initMobileAccordeonInFooter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMobileAccordeonInFooter", function() { return initMobileAccordeonInFooter; });
var footer = document.querySelector('.footer');
var footerNavButtons = document.querySelectorAll('.js-open-footer-nav');

var initMobileAccordeonInFooter = function initMobileAccordeonInFooter() {
...
var buttonModalClose = document.querySelector('.js-modal-close');
/**
...
var onEscModalClose = function onEscModalClose(evt) {
  if (Object(_utils__WEBPACK_IMPORTED_MODULE_1__["checkEscEvent"])(evt)) {
    closeModal();
  }
};
/**
...
var showModal = function showModal(evt) {
  var modalName = evt.currentTarget.dataset.targetModal;
...
var elementsWillAnimated = document.querySelectorAll('.animate-to-right, .animate-to-left, .animate-to-bottom, .animate-to-bottom-right, .animate-opacity');
...
var animate = function animate(element) {
  ...
  var intersectionCallback = function intersectionCallback(element) {
    return function (entries) {
      entries.forEach(function (entry) {
        var method = entry.isIntersecting ? 'add' : 'remove';
        element.classList[method]('visible');
      });
    };
  };

  var intersectionObserver = new IntersectionObserver(intersectionCallback(element));
  intersectionObserver.observe(element);
};

elementsWillAnimated.forEach(function (element) {
  animate(element);
});
...
/*!*************************!*\
  !*** ./src/js/utils.js ***!
  \*************************/
/*! exports provided: checkEscEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkEscEvent", function() { return checkEscEvent; });
var ESC_KEYCODE = 27;
/**
...
/***/ "./src/js/vendor/for-each-polyfill-ie11.js":
/*!*************************************************!*\
  !*** ./src/js/vendor/for-each-polyfill-ie11.js ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/js/vendor/intersection-observer.js":
/*!************************************************!*\
  !*** ./src/js/vendor/intersection-observer.js ***!
  \************************************************/
/*! no static exports found */
